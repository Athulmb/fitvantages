...
export default function FitvantagePass() {
  ...
  const handleLearnMore = (index, pass) => {
    ...
    if (!isExpanded) {
      ...
      } else if (pass.title === "PLAY") {
        navigate("/play#play-hero");
      }
    }
  };
            ...
            return (
              ...
              >
                ...
                <div className="flex gap-4 mt-6 flex-wrap justify-center">
                  <button 
                    onClick={openModal}
                    className="bg-[#2c2c2c] px-6 py-2 rounded-md text-sm hover:bg-[#3c3c3c] transition-colors"
                  >
                    TRY FOR FREE
                  </button>
                  <button
                    className="bg-green-500 text-black px-6 py-2 rounded-md text-sm font-semibold hover:bg-green-400 transition-colors"
                    onClick={() => handleLearnMore(index, pass)}
                  >
