                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between mt-6">
                            <div className="flex items-center gap-3">
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className="w-4 h-4 text-[#7FFA88] bg-gray-800 border-gray-600 rounded focus:ring-[#7FFA88] focus:ring-2"
                                />
                                <span className="text-gray-300 text-sm">Remember this device</span>
                            </div>
                            <button className="text-[#7FFA88] hover:text-green-300 text-sm underline transition-colors duration-200">
                                Forgot Password?
                            </button>
                        </div>
                        ...
                        <button
                            ...
                            className="w-full bg-[#7FFA88] hover:bg-[#6ef67d] text-gray-900 font-semibold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-[1.02] hover:shadow-[0_0_15px_4px_#7FFA88] mt-6"
                        >
                            Sign In
                        </button>
                    </div>
